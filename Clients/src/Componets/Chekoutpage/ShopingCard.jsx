...
const CartItemList = () => {
  ...
  const handleOrderButton = async () => {
    if (!formData.address || !formData.phone) {
      toast.error("Please provide a valid address and phone number.");
      return;
    }
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Refresh cart items and clear the form after successful order
        setCartItems([]);
        setFormData({
          phone: " ",
          address: " ",
      ...
      <div className="container-fluid pt-5 body">
        <div className="row">
          <div className="col-md-8">
            <h2 className="text-white">Cart Items</h2>
